...
export class ChartService {
  ...
  // Helper: canvas alapján megsemmisíti a meglévő chart-ot
  ...
  public createBudgetChart1(dashboardChartData: DataChart[]): Chart | null {
  ...
  public createCategoryChart2(dashboardData: MonthlyStatisticsDto): Chart | null {
  ...
  public createCategoryChart3(dashboardData: MonthlyStatisticsDto): Chart | null {
    const canvas = this.destroyExistingChart('CategoryChart');
    if (!canvas) return null;
